...
const CourseCard = ({code, className, sections}) => {
  return (
    <div className=" p-6 rounded-lg flex items-center justify-between mx-4 my-2">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <h3 className="text-xl font-semibold text-gray-700">{code} | {className}</h3>
          <p className="text-gray-600">{sections} Secciones</p>
        </div>
      </div>
